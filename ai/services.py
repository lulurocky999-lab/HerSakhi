...
def analyze_skill_gap(current_skills: list, target_role: str) -> dict:
    system_prompt = (
        ...
        "Return ONLY a JSON object with: 'current_skills_validated' (list), 'missing_skills' (list), "
        "and 'recommendations' (list of strings with actionable learning resources or steps)."
    )
